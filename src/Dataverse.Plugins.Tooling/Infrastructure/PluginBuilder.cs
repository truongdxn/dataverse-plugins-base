...
/// <para>
/// Only the plugin projects are built, never the whole solution. The tool runs from
/// <c>artifacts/tool</c> while plugin projects output to <c>src/&lt;project&gt;/bin</c>, so it can
/// never end up trying to overwrite itself while running.
/// </para>
/// </summary>
